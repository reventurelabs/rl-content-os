...
3. **Hand off.** Once a topic is picked, feed it straight into the `rl-content-pipeline` skill's define/interview steps (1-2) with the gathered evidence attached — don't restart from a blank page.
